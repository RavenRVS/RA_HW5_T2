import { CardInterface } from '../interface/newsBlockInterface';
 ...
 */
 export const topRightCardData: CardInterface = {
  img: 'https://a.d-cd.net/GTW9HXZoUmPtV5q-l1HKDek7Y8c-960.jpg',
 ...
 */
 export const banerData: CardInterface = {
  img: 'https://avatars.mds.yandex.net/i?id=56038e9b1fca83d1eac719dc052af9ea-4831580-images-thumbs&n=13',
  alt: 'Movie',
  href: '#',
};
